...
--
-- Host: 127.0.0.1    Database: bankoomorganization
-- ------------------------------------------------------
...
CREATE TABLE `organizationaccount` (
  ...
  CONSTRAINT `fk_organizationAccount_organization1` FOREIGN KEY (`idOrganization`) REFERENCES `organization` (`idOrganization`)
